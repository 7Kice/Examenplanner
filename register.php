...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $username_err = "Gebruikersnaam kan alleen letters, cijfers en laagstreepjes bevatten.";
    } else{
    ...
    if(empty(trim($_POST["password"]))){
        $password_err = "Voer hier uw wachtwoord in.";     
...
<body>
    <div class="wrapper">
        <h2>Registreren</h2>
        <p>Vul hier uw gegevens in om een account aan te maken.</p>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Heef u al een account? <a href="index.php">Log dan hier in</a>.</p>
        </form>
    </div>    
</body>
</html>