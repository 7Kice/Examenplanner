    ...
    */
    ...
    function gcalItemToRawEventDef(item, gcalTimezone) {
        ...
        return {
            ...
            cohort: item.cohort,
            benamingeenheid: item.benamingeenheid,
            codeeenheid: item.codeeenheid,
            afnamevorm: item.afnamevorm,
            tijd: item.tijd,
            duur: item.duur,
            beoordelaar: item.beoordelaar,
            leverancier: item.leverancier,
            toezicht: item.toezicht,
            aantal: item.aantal,
            studentnummer: item.studentnummer,
